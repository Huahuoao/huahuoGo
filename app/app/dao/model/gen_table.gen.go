...
type GenTable struct {
	...
	GenType        string    `gorm:"column:gen_type;default:0;comment:生成代码方式（0zip压缩包 1自定义路径）" json:"gen_type"`              // 生成代码方式（0zip压缩包 1自定义路径）
	GenPath        string    `gorm:"column:gen_path;default:/;comment:生成路径（不填默认项目路径）" json:"gen_path"`                      // 生成路径（不填默认项目路径）
